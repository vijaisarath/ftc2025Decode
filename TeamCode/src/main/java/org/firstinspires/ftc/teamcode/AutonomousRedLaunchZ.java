...
@Autonomous(name = "Auto Red LaunchZ", group = "Linear Opmode")
// @Disabled
public class AutonomousRedLaunchZ extends LinearOpMode {
    ...
    private void shooterMotorON() {
        myRobot.rightShooter.setPower(1.5);
        myRobot.leftShooter.setPower(1.5);
