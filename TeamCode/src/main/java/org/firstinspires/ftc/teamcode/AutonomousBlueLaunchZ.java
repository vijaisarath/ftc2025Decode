...
@Autonomous(name = "Auto Blue LaunchZ", group = "Linear Opmode")
// @Disabled
public class AutonomousBlueLaunchZ extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rotateAntiClockWise(0.5,16f);
        moveFront(0.85, 10.00f);
    ...
    private void shooterMotorON() {
        myRobot.rightShooter.setPower(1.0);
        myRobot.leftShooter.setPower(1.0);
        sendTelemetryData("Motor speed");
    }
