...
@Autonomous(name = "Autonomous Blue Depot", group = "Linear Opmode")
// @Disabled
public class AutonomousBlueDepot extends LinearOpMode {
...
//TAKE FIRST BALL
        ...
        rotateClockWise(0.35,25);

        sleep(300);
        moverStart();
        intakeAntiClockwise();

        moveRight(speed, 4.3f);
        moveBack(speed_intake,34.0f);

        intakeStop();
        moveFront(speed,22.0f);
        rotateAntiClockWise(speed,26);
        moveRight(speed,6.3f);
        ...
        shooterMotorOFF();
        intakeStop();
        moveLeft(speed,14.0f);

//////TAKE SECOND BALL
//        rotateClockWise(0.5,25);
//
//        sleep(500);
//        moverStart();
//        intakeAntiClockwise();
//        stopRobot();
//
//        moveRight(speed, 20.0f);
//        moveBack(speed_intake,38.0f);
//        intakeStop();
//        moveFront(speed,37.0f);
//        rotateAntiClockWise(speed,20);
//
//        moveFront(speed,20.0f);
//        rotateAntiClockWise(speed,7);
//
//        shooterMotorON();
//        sleep(1300);
//        moverStart();
